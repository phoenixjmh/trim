...
namespace ImGui
{
    ...
    // ~95% common code with ImGui::SliderFloat
    bool RangeSliderUInt(const char* label, uint32_t* v1, uint32_t* v2, uint32_t v_min, int32_t v_max, const char* display_format, float power, RangeSliderChangeType& change_type)
    {
        bool value_changed = false;
        change_type = RangeSliderChangeType::NONE;
        ImGuiWindow* window = GetCurrentWindow();
